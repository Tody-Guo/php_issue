...
class mysql {
 ...
 public function __construct($db_host = 'sql205.phpnet.us', $db_user = 'pn_15584718', $db_pwd = '666666', $db_database ='pn_15584718_eng', $conn = '', $coding = 'UTF8') {
 ...
 public function show_tables($database_name) {
  ...
  echo "现有数据表：" . $amount = $this->db_num_rows();
  echo "<br />";
  $i = 1;
  while ($row = $this->fetch_array()) {
 ...
 /* FIXME: what's this function mean??? */
 public function mysql_result_li($str, $value) {
  return mysql_result($str, $value);
 }

 /* fetch_array() function to get more result */
